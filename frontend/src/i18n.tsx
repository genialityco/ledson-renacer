...
const translations = {
  es: {
    ...
    connectionError: "No pudimos conectarnos con el servidor. Revisa tu conexión e inténtalo de nuevo.",
    retry: "Reintentar",
    moderationBlocked: "Esta imagen contiene contenido no permitido (sexual, armas o drogas). Elige otra foto.",
    nextStep: "Continuar",
    ...
    payWith: "Pagar",
    securePaymentWompi: "Pago seguro procesado por Wompi",
    paymentApproved: "¡Pago Aprobado!",
    uploadStepTitle: "Sube tu mejor foto o video",
    nowUploadPhoto: "Para vivir la experiencia en pantalla.",
    uploadPhoto: "Subir Foto",
    uploadVideo: "Subir Video",
    verticalVideoHint: "Tu contenido se ajustará al tamaño y a la duración de la experiencia en pantalla.",
    takeSelfie: "Tomar Selfie",
    selectedImage: "Imagen seleccionada:",
    removeImage: "Cambiar",
    magicReady: "¡Estamos listos para vivir la experiencia en pantalla!",
    ...
    trimSelectedLabelNoMax: "Tramo seleccionado: {sec}s",
  ...
  en: {
    ...
    retry: "Retry",
    moderationBlocked: "This image contains content that is not allowed (sexual, weapons or drugs). Please choose another photo.",
    nextStep: "Continue",
    ...
    payWith: "Pay with",
    securePaymentWompi: "Secure payment processed by Wompi",
    paymentApproved: "Payment Approved!",
    uploadStepTitle: "Upload your best photo or video",
    nowUploadPhoto: "To experience it live on screen.",
    uploadPhoto: "Upload Photo",
    uploadVideo: "Upload Video",
    verticalVideoHint: "Your content will be adjusted to the size and duration of the on-screen experience.",
    takeSelfie: "Take Selfie",
    selectedImage: "Selected image:",
    removeImage: "Change",
    magicReady: "We're ready for you to experience it on screen!",
    ...
    approxFranjaLabel: "Your booking will be shown on screen between:",
    ...
    trimSelectedLabelNoMax: "Selected clip: {sec}s",
