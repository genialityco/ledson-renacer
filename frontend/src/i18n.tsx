...
const translations = {
  es: {
    ...
    nextStep: "Continuar",
    step2Title: "Llena tus datos para tu reserva",
    step2Subtitle: "Usaremos estos datos para registrar tu reserva.",
  ...
  en: {
    ...
    nextStep: "Continue",
    step2Title: "Fill in your details for your booking",
    step2Subtitle: "We'll use this information to register your booking.",
    fullName: "Full Name",
    docId: "ID / Passport",
    email: "Email",
